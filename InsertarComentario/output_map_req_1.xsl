...
<!-- @generated mapFile="InsertarComentario/output_map_req_1.map" md5sum="710eb237faf5a1a851f3971aabaddba6" version="8.0.400" -->
<!--
*****************************************************************************
...
*   Output file(s):		smo://smo/name%3Dwsdl-primary/message%3D%257Bhttp%253A%252F%252FIBCRAAI%252FAIS%252FAIS_InsertarComentario%257DinvokeResponseMsg/xpath%3D%252Fbody/smo.xsd
*
...
<xsl:stylesheet
    ...
    xmlns:io2="wsdl.http://IBCRAAI/AIS/AIS_InsertarComentario"
    ...
    xmlns:io7="http://IBCRAAI/AIS/AIS_InsertarComentario"
    xmlns:io="http://schemas.xmlsoap.org/ws/2004/08/addressing"
    xmlns:map="http://IBCRA_AIS/InsertarComentario/output_map_req_1"
        ...
        <msl:datamap>
          <xsl:element name="dataObject">
            <xsl:attribute name="xsi:type">
              <xsl:value-of select="'io2:invokeResponseMsg'"/>
            </xsl:attribute>
