...
<!-- @generated mapFile="ObtenerRolesDeActividad/output_map_RolesActividad.map" md5sum="62e73c84eb2fcb9f404d23286d0cb50c" version="8.0.400" -->
<!--
*****************************************************************************
*   This file has been generated by the IBM XML Mapping Editor.
*
*   Mapping file:		output_map_RolesActividad.map
*   Map declaration(s):	output_map_RolesActividad
...
<xsl:stylesheet
    ...
    xmlns:in22="http://IBCRA_Mediaciones_Lib/ObtenerComboInformativas"
    ...
    xmlns:map="http://IBCRA_AIS/ObtenerRolesDeActividad/output_map_RolesActividad"
  ...
  <xsl:template match="/">
    <xsl:choose>
      <xsl:when test="msl:datamap">
        <msl:datamap>
          <xsl:element name="dataObject">
            ...
            <xsl:call-template name="map:output_map_RolesActividad2">
      ...
      <xsl:otherwise>
        <xsl:apply-templates select="body" mode="map:output_map_RolesActividad"/>
      </xsl:otherwise>
    </xsl:choose>
  </xsl:template>

  <!-- This rule represents an element mapping: "body" to "body".  -->
  <xsl:template match="body"  mode="map:output_map_RolesActividad">
    <body>
      <xsl:attribute name="xsi:type">
        <xsl:value-of select="'out:invokeResponseMsg'"/>
      </xsl:attribute>
      <out2:invokeResponse>
        <grupos>
          ...
          <xsl:apply-templates select="in:ObtenerRolesDeActividadResponse/output_ObtenerRolesDeActividad/Roles" mode="localRolesToNVP_Informativas_1893294646"/>
        </grupos>
      </out2:invokeResponse>
    </body>
  </xsl:template>
  ...
  <xsl:template name="map:output_map_RolesActividad2">
    <xsl:param name="body"/>
    <out2:invokeResponse>
      <grupos>
        <!-- a for-each transform: "Roles"(NVP_Informativas) to "out3:NVP_Informativas"(NVP_Informativas) -->
        <xsl:apply-templates select="$body/in:ObtenerRolesDeActividadResponse/output_ObtenerRolesDeActividad/Roles" mode="localRolesToNVP_Informativas_1893294646"/>
      </grupos>
    </out2:invokeResponse>
  </xsl:template>

  <!-- This rule represents a for-each transform: "Roles" to "out3:NVP_Informativas".  -->
  <xsl:template match="Roles"  mode="localRolesToNVP_Informativas_1893294646">
